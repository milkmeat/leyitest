...
- 剧情对话框
  - 剧情对话框是白底黑字的，通常出现在屏幕下部，有一个向下的三角箭头
  - 遇到剧情对话框的时候可以连续点击几下，跳过剧情对话
- 任务提示栏：
  - 在屏幕下部，聊天信息框的上方，是任务提示栏。
  - 任务提示栏左端是“卷轴”图标（右上角有红色数字提示表示有已完成未领取奖励的任务）后，点击会打开任务列表。通常分为 章节任务、成长任务、每日任务
  - “卷轴”图标右侧是当前任务，点击会直接跳转到任务执行入口。
...
- 新手指引：
  - 屏幕上如果有"手指"图示，需要点击指尖处完成新手指引，可能会切换到建筑升级、完成任务、奖励领取等界面。
  - 如果下一界面是升级界面。说明这是新手指引的目标，需要多次点击完成升级操作后继续。
  - 如果在升级界面没看到手指图标，则先别管手指指引了，连续升级完这个建筑再进行下一步
...
- 英雄界面：有两层，第一层列出多个英雄，第二层展示单个英雄（可以升级、升星），都只能点击左下角的返回箭头退出

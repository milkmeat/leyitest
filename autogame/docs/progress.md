...
| 优先级 | 组件 | 文件 | 说明 |
|--------|------|------|------|
| P0 | 配置加载器 | `src/config/loader.py` | 加载 accounts/squads/activity/system YAML |
| P0 | 配置 Schema | `src/config/schemas.py` | Pydantic 校验 schema |
| P0 | 配置文件 | `config/accounts.yaml` 等 | 100账号、10小队、活动规则、系统参数 |
